  ...
  <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                    <a href="manager_porders.php" class="active">
...
<table class="user-info">
 ...
 <td><button type="button" class="btn btn-primary"> <a class="but" href="m_add_porders.php">Add Product Order</a></button></td>
    </tr>
       ...
       $status=$row['status'];
          echo '<tr>
              ...
              <td>'.$row["quantity"].'</td>
               ...
               <td>'.$row["status"].'</td>
               <td>
               <button type="button" class="btn btn-link"> <a href="edit_manager_porders.php?editid='.$product_id.'">  <span class="bi bi-pencil-fill"></span></a></button>
               <button type="button" class="btn btn-link"><a href="delete_manager_porders.php?deleteid='.$product_id.'"> <span class="bi bi-trash"></span></button>
</td>
