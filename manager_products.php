  ...
  <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                    <a href="manager_products.php" class="active">
...
<table class="user-info">
 ...
 <td><button type="button" class="btn btn-primary"> <a class="but" href="m_add_product.php"> Add Product</a></button> </td>
    </tr>
        ...
        $quantity=$row['quantity'];
          ...
          echo '<tr>
              ...
              <td>'.$row["quantity"].'</td>
               ...
               <td>
               <button type="button" class="btn btn-link"> <a href="edit_manager_products.php?editid='.$product_id.'">  <span class="bi bi-pencil-fill"></span></a></button>
               <button type="button" class="btn btn-link"><a href="delete_manager_products.php?deleteid='.$product_id.'"> <span class="bi bi-trash"></span></button>
</td>
