...
<table class="user-info">
 ...
 <td><button type="button" class="btn btn-primary"> <a class="but" href="m_add_wip.php"> Add Item</a></button> </td>
    </tr>
       ...
       $reciever=$row['receiver'];
          echo '<tr>
              ...
              <td>'.$row["workstation_from"].'</td>
               ...
               <td>'.$row["receiver"].'</td>
               <td>
               <button type="button" class="btn btn-link"> <a href="edit_manager_wip.php?editid='.$batch_id.'">  <span class="bi bi-pencil-fill"></span></a></button>
               <button type="button" class="btn btn-link"><a href="delete_manager_wip.php?deleteid='.$batch_id.'"> <span class="bi bi-trash"></span></button>
</td>
