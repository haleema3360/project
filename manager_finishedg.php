...
color: white;
    ...
    <title>Manager-Finished Goods</title>
  </head>
  <body>
...
<table class="user-info">
 ...
 <td><button type="button" class="btn btn-primary"> <a class="but" href="m_add_finishedg.php"> Add Item</a></button> </td>
    </tr>
       ...
       $client=$row['client'];
          ...
          echo '<tr>
              ...
              <td>'.$row["division"].'</td>
               ...
               <td>
               <button type="button" class="btn btn-link"> <a href="edit_manager_finishedg.php?editid='.$product_id.'">  <span class="bi bi-pencil-fill"></span></a></button>
               <button type="button" class="btn btn-link"><a href="delete_manager_fg.php?deleteid='.$product_id.'"> <span class="bi bi-trash"></span></button>
</td>
